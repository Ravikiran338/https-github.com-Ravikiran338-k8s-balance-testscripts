...
import com.radiant.microservices.testscripts.BankingAppBalanceEnquiryBQTestScript;
import com.radiant.microservices.testscripts.BankingAppBalanceEnquiryCSTestScript;
...
public class TNCTest {
	...
	public void tncTestSuite() throws Exception {
		...
		BankingAppBalanceEnquiryCSTestScript bankingAppBalanceEnquiryCSTestScript = null;
		BankingAppBalanceEnquiryBQTestScript bankingAppBalanceEnquiryBQTestScript = null; 
		LogoutTestScript logoutTestScript = null;
			...
			//  Executing the Test script for Banking Modify User Test Script	
				 bankingAppBalanceEnquiryBQTestScript = new BankingAppBalanceEnquiryBQTestScript(testSuiteDetails);
				 bankingAppBalanceEnquiryBQTestScript.GetStatementBankingAccount();
				 
			//  Executing the Test script for Banking Modify User Test Script
				 bankingAppBalanceEnquiryCSTestScript = new BankingAppBalanceEnquiryCSTestScript(testSuiteDetails);
				 bankingAppBalanceEnquiryCSTestScript.GetStatementBankingAccount();
